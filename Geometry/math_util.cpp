...
double Lerp(double start, double end, double norm)
{
...
float &Vector2f::operator[](uint i)
{
	return dataByfloat[i & 0x01];
}

const float &Vector2f::operator[](uint i) const
{
	return dataByfloat[i & 0x01];
}
...
float &Vector3f::operator[](uint i)
{
	return dataByfloat[i % 3];
}

const float &Vector3f::operator[](uint i) const
{
	return dataByfloat[i % 3];
}
...
float &Vector4f::operator[](uint i)
{
	return dataByfloat[i & 0x03];
}

const float &Vector4f::operator[](uint i) const
{
	return dataByfloat[i & 0x03];
}
