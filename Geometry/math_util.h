...
DECLSPEC_DLL double Lerp(double start, double end, double norm);
DECLSPEC_DLL efloat Lerp(efloat start, efloat end, efloat norm);
DECLSPEC_DLL int Abs(int val);
DECLSPEC_DLL lint Abs(lint val);
DECLSPEC_DLL llint Abs(llint val);
DECLSPEC_DLL float Abs(float val);
DECLSPEC_DLL double Abs(double val);
DECLSPEC_DLL efloat Abs(efloat val);
DECLSPEC_DLL int Clamp(int val, int min, int max);
DECLSPEC_DLL float Clamp(float val, float min, float max);
DECLSPEC_DLL dfloat Clamp(double val, double min, double max);
